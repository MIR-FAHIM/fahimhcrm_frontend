...
const EmployeesList = () => {
  ...
  const columns = [
    ...
    { field: "department", headerName: "Department", flex: 1, valueGetter: (params) => params.row.department?.department_name || "-" },
    { field: "role", headerName: "Role", flex: 1, valueGetter: (params) => params.row.role?.role_name || "-" },
    { field: "isActive", headerName: "Active", flex: 0.5, type: "boolean", headerAlign: "center", align: "center" },
    {
      field: "view_details",
      headerName: "Actions",
      flex: 1,
