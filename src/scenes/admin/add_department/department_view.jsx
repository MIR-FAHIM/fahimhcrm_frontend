...
import { fetchDepartment, addDepartment } from "../../../api/controller/admin_controller/department_controller";
...
const DepartmentView = () => {
  ...
  return (
    <Box m="20px">
      <Header title="CREATE Department" subtitle="Add a New Department" />
      ...
      <Box mt="40px">
        <Header title="Department List" subtitle="Manage Departments" />
